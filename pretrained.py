...
class PretrainedList(object):
    ...
    #-----------Adding the line of code below to allow keras-bert to use uncased_base weights of BERT.-----------
    uncased_base = 'https://storage.googleapis.com/bert_models/2018_10_18/uncased_L-12_H-768_A-12.zip'
    #------------------------------------------------------------------------------------------------------------
